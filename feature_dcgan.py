...
if __name__ == '__main__':
    ...
    class _netG(nn.Module):
        def __init__(self, ngpu):
            ...
            self.main = nn.Sequential(
                ...
                nn.ConvTranspose2d( 4096, ngf * 8, 4, 1, 0, bias=False),
    ...
    for epoch in range(opt.niter):
        for i, data in enumerate(dataloader):
            ...
            fake_hid_ = fake_hid 
            fake_hid = fake_hid.view(batch_size, 4096, 1, 1)
            fake = netG(fake_hid)
            ...
            if i % 100 == 0:
                ...
                fake_hid = fake_hid.view(fake_hid.size(0), 4096, 1, 1)
                fake = netG.main(fake_hid)
