...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False, default='cifar10', help='cifar10 | lsun | imagenet | folder | lfw ')
    parser.add_argument('--dataroot', required=False,  default='/home/mcherti/work/data/cifar10', help='path to dataset')
    ...
    parser.add_argument('--outf', default='samples/samples_cond_dcgan_cifar10_bs32', help='folder to output images and model checkpoints')
